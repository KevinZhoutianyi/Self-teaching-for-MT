...
python main.py --valid_num_points 3000 --train_num_points 3000000 \
                --batch_size 200 --rep_num 100000 --test_num 1000000  --num_step_lr 1  --decay_lr 0.9 --num_workers 4\
                --train_w_num_points 50 --train_v_synthetic_num_points 100\
                --train_v_num_points 0 --train_A_num_points 50\
