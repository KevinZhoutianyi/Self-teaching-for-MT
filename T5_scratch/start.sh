...
python main.py --valid_num_points 3000 --train_num_points 3000000 \
                --batch_size 320 --rep_num 100000 --test_num 1000000  --num_step_lr 1 --num_workers 4\
                --train_w_num_points 80 --train_v_synthetic_num_points 080\
                --train_v_num_points 80 --train_A_num_points 80\
