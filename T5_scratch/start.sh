...
python main.py --valid_num_points 3000 --train_num_points 3000000 \
                --batch_size 720 --rep_num 2000 --test_num 1000000\
                --train_w_num_points 720 --train_v_synthetic_num_points 0\
                --train_v_num_points 0 --train_A_num_points 0\
                --valid_begin 1 --train_A 1  --model_name_student google/t5-small-lm-adapt --model_name_teacher t5-small\
