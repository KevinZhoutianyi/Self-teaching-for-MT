...
class Architect(object):
    ...
    def _compute_unrolled_w_model(self, input, target, input_attn, target_attn,    eta_w, w_optimizer):
        # BART loss
...
#https://github.com/pytorch/pytorch/blob/master/torch/optim/adam.py,https://pytorch.org/docs/stable/generated/torch.optim.Adam.html
        ...
        denom = (v.sqrt() / math.sqrt(bias_correction2)).add(1e-09)
    ...
    def step(self, input_w,  output_w, input_w_attn, output_w_attn, w_optimizer,
        ...
        unrolled_w_model = self._compute_unrolled_w_model(
            input_w, output_w, input_w_attn, output_w_attn,    lr_w, w_optimizer)
    ...
    def _hessian_vector_product_A(self, vector, input, target, input_attn, target_attn,    r=1e-2):
    ...
    def _outer_A(self, vector_s_dash, w_input, w_target, w_input_attn,  w_target_attn, input_v, input_v_attn,    unrolled_w_model, eta_w, eta_v, r=1e-2):
