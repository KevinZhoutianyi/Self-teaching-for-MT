...
python main.py --valid_num_points 3000 --train_num_points 1000000 \
                ...
                --train_v_num_points 0 --train_A_num_points 78 --pre_epochs 1\
                ...
                --w_lr 1e-3 --v_lr 1e-3 --A_lr 1e-3  --unrolled_w_lr 1e-3 --unrolled_v_lr 1e-3 --beta1 0.9 --beta2 0.98  --freeze 0\
                --exp_name BETA11,eval,noisedata,nofreeze,pre1
