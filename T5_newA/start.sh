...
python main.py --valid_num_points 3000 --train_num_points 3000000 \
                ...
                --valid_begin 1 --train_A 1  --model_name_teacher google/t5-small-lm-adapt --model_name_student google/t5-small-lm-adapt --model_name_de2en Onlydrinkwater/t5-small-de-en-mt\
                --w_lr 1e-3 --v_lr 1e-3 --A_lr 1e-3 --unrolled_w_lr 1e-3 --unrolled_v_lr 1e-3 \
                --exp_name BETA3.0,eval,newA
